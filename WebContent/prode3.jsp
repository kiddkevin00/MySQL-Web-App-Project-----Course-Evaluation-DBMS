...
<%
	...
	try {
		...
		rset = stmt
				.executeQuery("select P.pname,P.diploma from professorteachunder P where P.pid='008'");

		conn2 = ods.getConnection();
		stmt = conn2.createStatement();
		rset2 = stmt
				.executeQuery("select P.pname,P.diploma from professorteachunder P where P.pid='009'");

		conn3 = ods.getConnection();
		stmt = conn3.createStatement();
		rset3 = stmt
				.executeQuery("select P.pname,P.diploma from professorteachunder P where P.pid='010'");
...
<body
	...
	<div align="center" style="border: 5px solid brown">
		...
		<a href="http://localhost:9080/CS4111/prode2.jsp"> Previous page
		</a>
	</div>
