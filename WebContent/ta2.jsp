...
<body
	...
	<div align="center">
		...
		<form name="registerForm" action="register" method="post">
			<input type="button" title="Chemistry" value="04" id="pro1">
			<input type="button" title="Math" value="05" id="pro2"> <input
				type="button" title="Neuro" value="06" id="pro3">
		</form>
	</div>
	...
	<div align="center" style="border: 5px solid brown">
		...
		<a href="http://localhost:9080/CS4111/TAavg1.jsp">Check the
			average evaluation of each TA</a> <br> <a
			href="http://localhost:9080/CS4111/ta1.jsp"> Previous page /</a> <a
			href="http://localhost:9080/CS4111/ta3.jsp"> / Find more </a>
	</div>
